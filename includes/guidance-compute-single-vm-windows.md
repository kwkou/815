...
**反恶意软件。** 如果启用，安全中心将检查是否已安装反恶意软件。还可使用安全中心从 Azure 门户内安装反恶意软件。
...
2. 链接在 Azure 门户中打开后，必须输入某些设置的值：
    ...
    * 单击“购买”按钮。
3. 等待部署完成。
4. 参数文件包括硬编码管理员用户名和密码，强烈建议你立即更改它们。在 Azure 门户中，单击名为 `ra-single-vm0 ` 的 VM。然后，单击“支持 + 疑难解答”边栏选项卡中的“重置密码”。在“模式”下拉框中选择“重置密码”，然后选择新的“用户名”和“密码”。单击“更新”按钮来持久保存新的用户名和密码。
