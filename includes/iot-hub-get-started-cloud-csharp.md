...
1. 在 Visual Studio 中，使用“控制台应用程序”项目模板将新的 Visual C# Windows 经典桌面项目添加到当前解决方案。将项目命名为 **CreateDeviceIdentity**。
...
1. 在 Visual Studio 中，使用“控制台应用程序”项目模板将新的 Visual C# Windows 经典桌面项目添加到当前解决方案。将项目命名为 **ReadDeviceToCloudMessages**。
...
3. 在“NuGet 包管理器”窗口中，搜索“WindowsAzure.ServiceBus”，单击“安装”并接受使用条款。
    ...
    这样，便会下载、安装 [Azure 服务总线][lnk-servicebus-nuget]并添加对该程序包的引用，包括其所有依赖项。
