...
11. 若要使用 Maven 生成 **create-device-identity** 应用程序，请在命令提示符下于 create-device-identity 文件夹中执行以下命令：

    ```
    mvn clean package -DskipTests
    ```

12. 若要使用 Maven 运行 **create-device-identity** 应用程序，请在命令提示符下于 create-device-identity 文件夹中执行以下命令：
