...
2. 导航到 <a href="http://go.microsoft.com/fwlink/p/?LinkId=268300" target="_blank">Twitter 开发人员</a>网站、使用您的 Twitter 帐户凭据登录、导航到"我的应用程序"，并选择您的 Twitter 应用。

    ![](./media/mobile-services-register-twitter-access/mobile-twitter-my-apps.png)

3. 在应用的"详细信息"选项卡中，记下以下值：
...
4. 登录到 [Windows Azure 管理门户]、单击"移动服务"，然后单击您的移动服务。

5. 单击"标识"选项卡、输入从 Twitter 获取的"使用者密钥"和"使用者机密"值，然后单击"保存"。 

	![](./media/mobile-services-register-twitter-access/mobile-identity-tab-twitter-only.png)

2. 单击"配置"选项卡、向下滚动到"应用设置"、输入您从 Twitter 网站获取的下述每个项的"名称"和"值"对，然后单击"保存"。
...
[应用设置]: http://msdn.microsoft.com/zh-cn/library/windowsazure/b6bb7d2d-35ae-47eb-a03f-6ee393e170f7<!--HONumber=41-->
