...
3. 在 ToDoActivity.java 文件中，添加  `cacheUserToken` 方法的以下定义。
    ...
    >[WACOM.NOTE]如果对您数据的令牌访问被认为非常敏感，并且有人可能会获得对设备的访问权，则可以使用加密进一步保护令牌。但是，完全安全的解决方案超出了本教程的范围并且取决于您的安全要求。


4. 在 ToDoActivity.java 文件中，添加  `loadUserTokenCache` 方法的以下定义。
