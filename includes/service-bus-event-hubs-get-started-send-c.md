## 将消息发送到事件中心
在本节中，我们将编写用于将事件发送到事件中心的 C 应用。我们将从 [Apache Qpid 项目](http://qpid.apache.org/)中利用 Proton AMQP 库。这类似于从 C 中将 Service Bus 队列和主题与 AMQP 配合使用，如[此处](https://code.msdn.microsoft.com/windowsazure/Using-Apache-Qpid-Proton-C-afd76504)所示。有关详细信息，请参阅 [Qpid Proton 文档](http://qpid.apache.org/proton/index.html)。
