...
1. 从 [Qpid AMQP Messenger 页](http://http://qpid.apache.org/components/index.html)中，单击 **Qpid Proton**  链接，并根据环境按照说明操作。 我们将假定一个 Linux 环境，例如，使用 Ubuntu 14.04 的  [Azure Linux VM](http://www.windowsazure.cn/zh-cn/documentation/articles/virtual-machines-linux-tutorial-portal-rm)。
