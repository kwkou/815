...
<tags ms.service="legal" ms.date="06/2016" wacn.date="06/2016" wacn.lang="cn"/>

> [AZURE.LANGUAGE]
- [中文](/support/sla/service-fabric/)
- [English](/support/service-fabrics-en/)
...
Service Fabric 是一项免费服务，因此不适用服务级别协议。Service Fabric 群集的可用性基于所用基础虚拟机和存储资源的服务级别协议。有关详细信息，请参见[虚拟机的服务级别协议](/support/sla/virtual-machines/)和[存储的服务级别协议](/support/sla/storage/)。
