...
<tags ms.service="legal" ms.date="06/2016" wacn.date="06/2016" wacn.lang="en"/>
...
Service Fabric is a free service, therefore, it does not have a financially backed SLA itself.The availability of your Service Fabric cluster is based on the SLA of the underlying virtual machines and storage resources used. Please see the [Virtual Machine SLA](/support/sla/virtual-machines/) and [Storage SLA](/support/sla/storage/) for more details.
