...
> [AZURE.LANGUAGE]
- [中文](/support/legal/sla/virtual-machines/)
- [English](/support/legal/sla/virtual-machines-en/)
...
2. "**Virtual Machine**" refers to persistent instance types that can be deployed individually or as part of an Availability Set. 

3. "**Fault Domain**" is a collection of servers that share common resources such as power and network connectivity.

4. "**Update Domain**" refers to a set of Azure instances to which platform updates are concurrently applied.
