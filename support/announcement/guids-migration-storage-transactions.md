...
|数据管理	|	异地冗余	|	存储事务数（以 10,000 计）	|	964c283a-83a3-4dd4-8baf-59511998fe8b	|	标准 IO – 块 Blob 写入操作单元（以 10,000 计）|	45ff39f6-c7a6-40fb-a124-cf5b280ba092	|
|数据管理	|	        	|	存储事务数（以 10,000 计）	|	964c283a-83a3-4dd4-8baf-59511998fe8b	|	标准 IO – 文件删除操作单元（以 10,000 计）	|	767660fa-525b-436f-a375-6da3e26f09b2 |
|数据管理	|	        	|	存储事务数（以 10,000 计）	|	964c283a-83a3-4dd4-8baf-59511998fe8b	|	标准 IO – 文件列表操作单元（以 10,000 计）	|	be63f96a-ef4b-42c1-9365-f9fa0e7431d0 |
|数据管理	|	        	|	存储事务数（以 10,000 计）	|	964c283a-83a3-4dd4-8baf-59511998fe8b	|	标准 IO – 文件协议操作单元（以 10,000 计）	|	6a99015c-d33f-4f46-ae59-2e4d14091aa8 |
|数据管理	|	        	|	存储事务数（以 10,000 计）	|	964c283a-83a3-4dd4-8baf-59511998fe8b	|	标准 IO – 文件读取操作单元（以 10,000 计）	|	761abab8-259d-4206-a6ae-707ed03fc540 |
