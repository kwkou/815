...
此页列出了我们计划发布的 Azure HDInsight 文章或文章更新。你可以通过 GitHub 拉取请求来更新本文，更改分配给文章的优先级，让我们知道需要在哪些方面进行改进。
...
存储 | 文章说明了 WASB 和 Data Lake Storeas 存储选项 | 2 | 待执行 | [@mumian](https://github.com/mumian) | -
