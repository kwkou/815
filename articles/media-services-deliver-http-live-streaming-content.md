...
本文是介绍 Azure Media Services 编程的系列主题中的一篇。前一个主题是[如何：交付流内容](/documentation/articles/media-services-deliver-streaming-content)。
...
-   [如何监视 Media Services 帐户](/documentation/articles/media-services-monitor-services-account)
-   [如何管理 Media Services 中的内容](/documentation/articles/media-services-manage-content)
