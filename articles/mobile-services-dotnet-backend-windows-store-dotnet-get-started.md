<properties
	pageTitle="适用于 Windows Universal 应用的移动服务入门 | Windows Azure"
...
>[AZURE.TIP]如果你不熟悉如何使用 Windows Azure 进行移动开发，请[开始使用 Azure Mobile Apps](/documentation/articles/app-service-mobile-dotnet-backend-windows-store-dotnet-get-started-preview) 而不是 Azure 移动服务；Mobile Apps 提供[更多的优势](/documentation/articles/app-service-mobile-value-prop-migration-from-mobile-services-preview)。
