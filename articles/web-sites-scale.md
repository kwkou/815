...
为提高你的 Web 应用在 Azure 上的性能和吞吐量，你可以使用 Azure 经典门户将 Web 托管计划模式从“免费”缩放为“共享”、“基本”或“标准”。
...
可在经典门户的“缩放”选项卡中轻松地更改模式并进行配置。您可以根据需要向上或向下缩放。这些更改只需数秒即可生效，可影响 Web 托管计划中的所有 Web 应用。无需更改代码或重新部署应用程序。
...
2. 该链接指向 Azure 经典门户的 SQL Server 选项卡，可在其中配置数据库的“版本”和“最大大小”：
