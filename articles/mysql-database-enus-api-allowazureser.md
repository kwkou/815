...
# Updating Servers - Allowing Azure Service Access
...
### Request Body
The creation or updating of MySQL on Azure servers requires writing the following parameters. A JSON example file is provided below:
```
{
  "properties": {
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td>Allow other Azure services to access settings</td>
  </tr>
</table>
