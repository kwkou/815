...
[Azure 门户][azure-portal]中已提供 Microsoft Azure DocumentDB。首先，你必须注册 Microsoft Azure 订阅。注册 Microsoft Azure 订阅之后，你可以将 DocumentDB 帐户添加到 Azure 订阅。有关添加 DocumentDB 帐户的说明，请参阅[创建 DocumentDB 数据库帐户](/documentation/articles/documentdb-create-account)。
...
- Azure 门户中的文档资源管理器，如[使用文档资源管理器批量添加文档](/documentation/articles/documentdb-view-json-document-explorer#BulkAdd)所述。
