...
首先，使用 Azure 订阅凭据登录到 [Azure 经典门户](https://manage.windowsazure.cn/)，然后创建名为 TestVNET 的虚拟网络。
...
1.	在本地计算机上的 Azure 经典门户中，单击左窗格中的“网络”，然后验证 TestVNET 的“状态”列是否已设置为“已创建”。
...
接下来，转到本地计算机上的 Azure 经典门户并等待，一直等到 TestVNET 虚拟网络显示状态“已连接”。
...
5.	在底部的命令栏中，单击**“保存”**。
6.	在 Azure 经典门户的左窗格中，单击“虚拟机”，然后单击 DC2 旁边的“状态”列。
...
1.	在本地计算机上的 Azure 经典门户中，依次单击左窗格中的“网络”、“TestVNET”、“仪表板”。
2.	在任务栏中，单击“删除网关”。出现提示时单击“是”。等待，直到网关删除完毕且其状态更改为“未创建网关”。

如果你删除网关后又想要还原测试环境，则必须先创建新的网关。

1.	从本地计算机上的 Azure 经典门户中，单击左窗格中的“网络”，然后单击“TestVNET”。在“仪表板”页上，你会看到状态“未创建网关”。
...
接下来，请转到本地计算机上的 Azure 经典门户中等待，一直等到 TestVNET 虚拟网络显示状态为“已连接”。
