...
#### 选择计算模型
[Azure Web Apps、云服务和虚拟机比较](/documentation/articles/choose-web-site-cloud-service-vm)提供了有关如何选择计算模型的更多详细信息。
...
这些 SDK 可帮助你构建、部署和管理 Azure 应用程序。可从 [www.windowsazure.com](/downloads/) 或 GitHub 获得它们，并且它们可以与 Visual Studio 和 Eclipse 结合使用。Azure 还提供了开发人员可以将其与任何编辑器或开发环境结合使用的命令行工具，包括用于从 Linux 和 Macintosh 系统将应用程序部署到 Azure 的工具。
