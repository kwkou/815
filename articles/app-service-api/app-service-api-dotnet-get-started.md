...
* Azure 帐户 - 可以[注册 Azure 帐户](/pricing/1rmb-trial/?WT.mc_id=A261C142F)。
...
3. 如果尚未下载“发布配置文件”，请转到 [Azure 门户预览版](https://portal.azure.cn)下载。如果尚未创建 Web 应用，请创建一个。在“Web 应用”边栏选项卡中，单击“...更多”>“获取发布配置文件”。
...
17. 打开 [Azure 门户预览版](https://portal.azure.cn/)。

	Azure 门户预览版是用于管理 Azure 资源（例如 API 应用）的 Web 界面。
...
19. 在“应用程序服务”边栏选项卡中，找到并单击新的 API 应用。（在 Azure 门户预览版中，右侧打开的窗口称为*边栏选项卡*。）
...
3. 在“添加 REST API 客户端”对话框中，依次单击“Swagger URL”和“选择现有 Swagger 元数据文件”。

4. 打开浏览器，从 `https://{your data tier API app name}.chinacloudsites.cn/swagger/docs/v1` 下载 Swagger 元数据文件。

5. 在“添加 REST API 客户端”对话框中，选择已下载的 json 文件，然后单击“确定”。
...
3. 如果尚未下载“发布配置文件”，请转到 [Azure 门户预览版](https://portal.azure.cn)下载。如果尚未创建 API 应用，请创建一个。在“Web 应用”边栏选项卡中，单击“...更多”>“获取发布配置文件”。
...
1. 转到 [Azure 门户预览版](https://portal.azure.cn/)，然后导航到为托管 TodoListAPI（中间层）项目而创建的 API 应用的“API 应用”边栏选项卡。
