...
> [AZURE.LANGUAGE]
- [中文](/documentation/articles/cdn-api-query-purge/)
- [English](/documentation/articles/cdn-enus-api-query-purge/)

# <a name="-"></a>Cache refresh – query cache refresh progress
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>purgeId</td>
    <td>Cache refresh operation unique identifier</td>
  </tr>
</table>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>Files</td>
    <td>File refresh results</td>
  </tr>
  <tr>
    <td>Directories</td>
    <td>Directory refresh results
    </td>
  </tr>
  <tr>
    <td>Status</td>
