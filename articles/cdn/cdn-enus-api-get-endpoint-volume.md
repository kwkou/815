<properties
    ...
    urlDisplayName="CDN"
    pageTitle="Azure China CDN API doc-get usage"
...
> [AZURE.LANGUAGE]
- [中文](/documentation/articles/cdn-api-get-endpoint-volume/)
- [English](/documentation/articles/cdn-enus-api-get-endpoint-volume/)

# <a name="-"></a>Traffic – Get traffic information for CDN endpoints
