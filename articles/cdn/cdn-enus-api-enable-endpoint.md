<properties
    ...
    urlDisplayName="CDN"
    pageTitle="Azure China CDN API doc-enable endpoint"
...
> [AZURE.LANGUAGE]
- [中文](/documentation/articles/cdn-api-enable-endpoint/)
- [English](/documentation/articles/cdn-enus-api-enable-endpoint/)

# <a name="-"></a>CDN endpoint management – enable disabled CDN endpoint
