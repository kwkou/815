...
-   [调试 Azure 应用程序][调试 Azure 应用程序]
  ...
  [后续步骤]: #nextsteps
  [其他资源]: #additional
  [在 Azure 中启用诊断]: /develop/net/common-tasks/diagnostics/
  ...
  [Java]: /develop/java/how-to-guides/table-service/
  [Python]: /develop/python/how-to-guides/table-service/
  [PHP]: /develop/php/how-to-guides/table-service/
