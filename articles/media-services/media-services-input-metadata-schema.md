...
| 名称 | 类型 | 说明 |
| --- | --- | --- |
| <p>**Id**</p><p>必需</p>|**xs:int** |此音频或视频轨道从零开始的索引。<br /><br /> 这并不一定是 MP4 文件中使用的 TrackID。 |
| **Codec** |**xs:string** |视频轨道编解码器字符串。 |
| **CodecLongName** |**xs:string** |音频或视频轨道编解码器长名称。 |
| <p>**TimeBase**</p><p>必需</p> |**xs:string** |时间基准。示例：TimeBase="1/48000" |
...
| <p>**Channels**</p><p> 必需</p> |**xs:int** |音频通道数（0 或更多）。 |
| <p>**SamplingRate**</p><p> 必需</p>|**xs:int** |音频采样率（样本数/秒或 Hz）。 |
...
| <p>**Width**</p><p>必需</p> |**xs:int** |以像素为单位的编码视频宽度。 |
| <p>**Height**</p><p>必需</p> |**xs:int** |以像素为单位的编码视频高度。 |
| <p>**DisplayAspectRatioNumerator**</p><p>必需</p> |**xs:double** |视频显示纵横比分子。 |
| <p>**DisplayAspectRatioDenominator**</p><p> 必需</p>|**xs:double** |视频显示纵横比分母。 |
| <p>**DisplayAspectRatioDenominator**</p><p> 必需</p> |**xs:double** |视频样本纵横比分子。 |
| **SampleAspectRatioNumerator** |**xs:double** |视频样本纵横比分子。 |
| **SampleAspectRatioNumerator** |**xs:double** |视频样本纵横比分母。 |
| <p>**FrameRate**</p><p> 必需</p> |**xs:decimal** |采用 .3f 格式的测量的视频帧速率。 |
...
| 名称 | 类型 | 说明 |
| --- | --- | --- |
| <p>**key**</p><p> 必需</p> |**xs:string** |键/值对中的键。 |
| <p>**value**</p><p> 必需</p> |**xs:string** |键/值对中的值。 |
...
| 名称 | 类型 | 说明 |
| --- | --- | --- |
| <p>**ProgramId**</p><p>必需</p> |**xs:int** |节目 ID |
| <p>**NumberOfPrograms**</p><p> 必需</p>|**xs:int** |节目数。 |
| <p>**PmtPid**</p><p> 必需</p> |**xs:int** |节目映射表 (PMT) 包含有关节目的信息。有关详细信息，请参阅 [PMt](http://en.wikipedia.org/wiki/MPEG_transport_stream#PMT)。 |
| <p>**PcrPid**</p><p> 必需</p>|**xs:int** |由解码器使用。有关详细信息，请参阅 [PCR](http://en.wikipedia.org/wiki/MPEG_transport_stream#PCR) |
...
| 名称 | 类型 | 说明 |
| --- | --- | --- |
| <p>**Default**</p><p>必需</p> |**xs:int** |将此属性设置为 1，表示这是默认演示。 |
| <p>**Dub**</p><p>必需</p> |**xs:int** |将此属性设置为 1，表示这是译制的演示。 |
| <p>**Original**</p><p>必需</p> |**xs:int** |将此属性设置为 1，表示这是原始演示。 |
| <p>**Comment**</p><p>必需</p> |**xs:int** |将此属性设置为 1，表示此轨道包含注释。 |
| <p>**Lyrics**</p><p>必需</p> |**xs:int** |将此属性设置为 1，表示此轨道包含歌词。 |
| <p>**Karaoke**</p><p>必需</p> |**xs:int** |将此属性设置为 1，表示它代表卡拉 OK 曲目（背景音乐，没有人声）。 |
| <p>**Forced**</p><p>必需</p> |**xs:int** |将此属性设置为 1，表示这是强制播放的演示。 |
| <p>**HearingImpaired**</p><p>必需</p> |**xs:int** |将此属性设置为 1，表示此轨道针对听觉障碍人士。 |
| <p>**VisualImpaired**</p><p>必需</p> |**xs:int** |将此属性设置为 1，表示此轨道针对视觉障碍人士。 |
| <p>**CleanEffects**</p><p>必需</p> |**xs:int** |将此属性设置为 1，表示此轨道具有清晰效果。 |
| <p>**AttachedPic**</p><p>必需</p> |**xs:int** |将此属性设置为 1，表示此轨道包含图片。 |
