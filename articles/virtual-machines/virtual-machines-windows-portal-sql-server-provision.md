...
1. 使用帐户登录到 [Azure 门户预览](https://portal.azure.cn)。
	...
	>[AZURE.NOTE] 如果没有 Azure 帐户，请访问 [Azure 试用版](/pricing/1rmb-trial/)。
...
>[AZURE.NOTE] SQL Server Express 版本的虚拟机映像不会自动启用 TCP/IP 协议。即使对公共和专用连接选项也是如此。
...
>[AZURE.NOTE] 对于非 2016 Enterprise 版本的 SQL Server 映像，启用 R Services 的选项处于禁用状态。
