<properties
    pageTitle="Azure 中 Linux VM 的存储解决方案 | Azure"
...
* [高级存储](/documentation/articles/storage-premium-storage/)可以为 I/O 密集型工作负荷（例如 MongoDB 分片群集）提供高性能且低延迟的磁盘支持。 高级存储目前仅支持 Azure VM 磁盘。
