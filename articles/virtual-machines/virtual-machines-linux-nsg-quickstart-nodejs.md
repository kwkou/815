<properties
    pageTitle="使用 Azure CLI 1.0 打开 Linux VM 的端口 | Azure"
...
- [Azure CLI 2.0](/documentation/articles/virtual-machines-linux-nsg-quickstart/) - 适用于资源管理部署模型的下一代 CLI

## <a name="quick-commands"></a> 快速命令
若要创建网络安全组和规则，需要安装 [Azure CLI 1.0](/documentation/articles/cli-install-nodejs/) 并使用 Resource Manager 模式：
