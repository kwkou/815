...
| 方法 | 文章 |
| --- | --- |
| Azure 门户 |[使用门户创建运行 Windows 的虚拟机](/documentation/articles/virtual-machines-windows-hero-tutorial/) |
...
### 登录到 VM
使用 Azure 门户中的“连接”按钮[启动远程桌面 (RDP) 会话](/documentation/articles/virtual-machines-windows-connect-logon/)。尝试使用远程连接时，有时可能会出错。如果遇到这种情况，请查看[对运行 Windows 的 Azure 虚拟机的远程桌面连接进行故障排除](/documentation/articles/virtual-machines-windows-troubleshoot-rdp-connection/)中的帮助信息。
