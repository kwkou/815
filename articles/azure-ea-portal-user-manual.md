...
(1)	首先我们以 Market 账户 (market@contoso.partner.onmschina.cn)，登陆 [Azure 经典管理门户](https://manage.windowsazure.cn)  
...
(4)	然后我们注销当前登录，以企业管理员 (admin) 身份，登陆 [Azure 经典管理门户](https://manage.windowsazure.cn)
