...
无论你的现有 Web 资产是 .NET、PHP、Java、Node.js 还是 Python，现在都可在网站中运行。你可以使用熟悉的 [FTP] 工具将它们移动到网站。如果频繁创建数字市场营销活动，则源代码控制系统中可能存在现有 Web 资产。你可以直接从流行的源代码管理选项部署到网站，如 [Visual Studio] 和 本地 [Git]、GitHub、Mercurial 等。
