...
| 密钥保管库 | [Azure 密钥保管库日志记录](/documentation/articles/key-vault/key-vault-logging/) |
| Azure 搜索 | [允许并使用搜索流量分析](/documentation/articles/search-traffic-analytics/) |
| 数据湖存储 | [Accessing diagnostic logs for Azure Data Lake Store（访问 Azure Data Lake Store 的诊断日志）](/documentation/articles/data-lake-store-diagnostic-logs/) |
| 数据湖分析 | [Accessing diagnostic logs for Azure Data Lake Analytics（访问 Azure Data Lake Analytics 的诊断日志）](/documentation/articles/data-lake-analytics-diagnostic-logs/) |
| Logic Apps | 没有可用架构。 |
| Azure 批处理 | [Azure 批处理诊断日志记录](/documentation/articles/batch-diagnostics/) |
| Azure 自动化 | [适用于 Azure 自动化的 Log Analytics](/documentation/articles/automation-manage-send-joblogs-log-analytics/) |
| 事件中心 | 没有可用架构。 |
| 服务总线 | 没有可用架构。 |
| 流分析 | 没有可用架构。 |
