...
> [AZURE.IMPORTANT] 从版本 1.9.2 开始，查询已分区集合时，可能会出现 System.NotSupportedException。为了避免此错误，请确保主机进程为 64 位。对于可执行的项目，可以通过在项目属性窗口中的“生成”选项卡上取消选中“首选 32 位”选项来实现此目的。
