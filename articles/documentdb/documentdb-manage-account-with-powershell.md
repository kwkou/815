<properties
    pageTitle="DocumentDB 自动化 - 使用 Powershell 管理 | Azure"
    description="使用 Azure Powershell 管理 DocumentDB 帐户。"
    services="documentdb"
    author="dmakwana"
    manager="jhubbard"
    editor=""
...
使用此命令可创建 DocumentDB 数据库帐户。 可以将新数据库帐户配置为具有特定[一致性策略](/documentation/articles/documentdb-consistency-levels/)的单区域或[多区域][scaling-globally]。
