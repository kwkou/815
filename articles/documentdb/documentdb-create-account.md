...
2. 在左侧导航栏中，依次单击“新建”、“数据库”、“NoSQL (DocumentDB)”。

    ![Azure 门户预览的屏幕截图，突出显示更多服务和 NoSQL (DocumentDB)](./media/documentdb-create-account/create-nosql-db-databases-json-tutorial-1.png)  
...
- Azure 门户预览，如 [Create a DocumentDB collection using the Azure portal](/documentation/articles/documentdb-create-collection/)（使用 Azure 门户预览创建 DocumentDB 集合）中所述。
