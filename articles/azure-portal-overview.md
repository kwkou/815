...
您必须拥有有效的 Azure 订阅，才能完整浏览本教程。如果你没有，请立即[注册1元试用版](/pricing/1rmb-trial/)。拥有订阅后，你便可以访问[门户预览](https://portal.azure.cn)。
...
- 你学习了如何获得帮助和支持
 ...
 Azure 门户预览大大简化了在云中构建和管理应用程序的工作。请参阅[管理博客](https://azure.microsoft.com/blog/topics/management/)，了解最新动态。
