...
- [Redis Azure 缓存文档](http://azure.microsoft.com/documentation/services/cache/)：此页提供有关使用 Redis Azure 缓存的许多优秀文章链接。
...
- [如何将 ASP.NET 会话状态用于 Azure 网站](../app-service-web/web-sites-dotnet-session-state-caching.md)：此主题说明如何为会话状态使用 Azure Redis 缓存服务。
