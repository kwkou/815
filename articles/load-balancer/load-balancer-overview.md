...
务必了解 Azure 经典[部署模型](/documentation/articles/resource-manager-deployment-model/)与 Resource Manager 部署模型之间的差异。 Azure 负载均衡器在每个模型中的配置各不相同。
...
* 源 NAT
    ...
    有关此主题的更多详细信息，请参阅[出站连接](/documentation/articles/load-balancer-outbound-connections/)一文。
