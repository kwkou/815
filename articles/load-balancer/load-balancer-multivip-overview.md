...
* 公共 IP 地址会影响计费。 有关详细信息，请参阅 [IP 地址定价](/pricing/details/reserved-ip-addresses/)
* 订阅有所限制。 有关详细信息，请参阅[服务限制](/documentation/articles/azure-subscription-service-limits/#networking-limits)。
