...
2. 使用以下设置创建资源组：
    ...
    有关详细信息，请参阅[创建资源组](/documentation/articles/virtual-machines-windows-quick-create-powershell?toc=%2fazure%2fload-balancer%2ftoc.json/)中的第 2 步。
...
4. 按照[创建 Windows VM](/documentation/articles/virtual-machines-windows-quick-create-powershell?toc=%2fazure%2fload-balancer%2ftoc.json/) 中步骤 3 至 5 的说明准备创建具有单个 NIC 的 VM。 执行步骤 6.1，使用以下命令而不是步骤 6.2：

        $availset = Get-AzureRmAvailabilitySet -ResourceGroupName "contosofabrikam" -Name "myAvailset"
        New-AzureRmVMConfig -VMName "VM1" -VMSize "Standard_DS1_v2" -AvailabilitySetId $availset.Id

    然后完成[创建 Windows VM](/documentation/articles/virtual-machines-windows-quick-create-powershell?toc=%2fazure%2fload-balancer%2ftoc.json/) 的步骤 6.3 至 6.8。
