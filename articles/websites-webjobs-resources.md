...
Azure 经典门户中的 Web 作业仪表板提供了强大的管理功能，可让你全面控制 Web 作业的执行，包括调用 Web 作业中的各个函数。该仪表板还会显示函数运行时和日志记录输出。
...
* [如何使用 Azure 经典门户部署 Web 作业](/documentation/articles/web-sites-create-web-jobs)
...
* [在 Azure 经典门户中创建计划的 Web 作业](/documentation/articles/web-sites-create-web-jobs#CreateScheduled)
