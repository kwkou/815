...
1. 准备好部署到 Azure 后，请从 [Azure 经典管理门户][]获取部署的 DNS 名称。过渡部署的 DNS 名称格式为 http://*&lt;guid&gt;*.cloudapp.net，其中，*&lt;guid&gt;* 是 Azure 分配的 GUID 值。
...
## <a name="debugging_specific_role_instance"></a> 调试多实例部署中的特定角色实例 ##
