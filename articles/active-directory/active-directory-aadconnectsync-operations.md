...
3. 确保“连接器”选项卡仍处于选中状态。针对每个 **Active Directory 域服务**类型的连接器单击“运行”，然后选择“增量同步”和“确定”。
4. 选择 **Azure Active Directory (Microsoft)** 类型的连接器。单击“运行”，选择“增量同步”，然后选择“确定”。
...
5. 对数据或配置进行必要的更改并再次运行这些步骤（导入和同步及身份验证），直到要导出的更改都按预期进行。
