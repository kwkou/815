<properties
    pageTitle="Office 365 和 Azure AD 用户证书续订 | Azure"
...
有关详细信息，请阅读 [Repairing the trust](/documentation/articles/active-directory-aadconnect-federation-management/)（修复信任）。
