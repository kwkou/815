...
一旦部署密码重置，最常见的后续步骤之一便是查看其在组织中的使用情况。例如，你可能希望了解用户对密码重置的注册情况，或者在过去几天内进行了多少个密码重置。下面是一些常见问题，你将能够使用当今 [Azure 经典管理门户](https://manage.windowsazure.cn)中的密码管理报告来回答这些问题：
...
已对此租户完全禁用密码重置。若要解决此问题，请参阅[此文](/documentation/articles/active-directory-passwords-troubleshoot/)。 | 已失败
用户已成功重置密码|已成功
