<properties
    pageTitle="在 Android 上进行 Azure Active Directory 基于证书的身份验证 | Azure"
    description="了解在解决方案中使用 Android 设备配置基于证书的身份验证时的支持方案和要求"
...
# 在 Android 上进行 Azure Active Directory 基于证书的身份验证
