...
此外，只需[单击四下](/documentation/articles/active-directory-aadconnect-get-started-express/)，Azure AD 就能与现有的 Windows Server Active Directory 集成，使组织能够运用现有的本地标识管理系统投资来管理对基于云的 SaaS 应用程序的访问。
