<properties
    pageTitle="在 Azure 虚拟网络中安装 Active Directory 林 | Microsoft 文档"
...
## <a name="how-does-this-differ-from-on-premises"></a>这与在本地安装有什么不同？
...
使用在本地所用的相同例程[安装 AD DS](https://technet.microsoft.com/zh-cn/library/jj574166.aspx)（也就是说，可以使用 UI、应答文件或 Windows PowerShell）。 需要提供管理员凭据来安装新林。 若要指定 Active Directory 数据库、日志和 SYSVOL 的位置，请将默认存储位置从操作系统驱动器更改为已附加到 VM 的额外数据磁盘。
...
有关如何使用 Windows PowerShell 的详细信息，请参阅 [Get Started with Azure Cmdlets](https://msdn.microsoft.com/zh-cn/library/azure/jj554332.aspx)（Azure Cmdlet 入门）和 [Azure Cmdlet 参考](https://msdn.microsoft.com/zh-cn/library/azure/jj554330.aspx)。
