...
请了解如何[注册应用](/documentation/articles/active-directory-v2-app-registration/)，获取详细信息。
...
## 协议
如果已准备好查看部分示例请求，请从下列教程之一开始。每个教程对应一种特定的身份验证方案。如果在确定适当的流时需要帮助，请查看[可以使用 v2.0 构建的应用类型](/documentation/articles/active-directory-v2-flows/)。
...
- [使用 OAuth 2.0 客户端凭据流构建守护程序或服务器端进程](/documentation/articles/active-directory-v2-protocols-oauth-client-creds/)
