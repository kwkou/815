...
迁移后，可在 [Azure 门户]中开始使用新的应用服务。下面是曾在 [Azure 经典管理门户]中执行的特定操作的某些注意事项，及其应用服务的等效功能。
...
> [AZURE.NOTE] 如果通知中心是“混合”类型，则它不可见。“混合”类型的通知中心同时利用通知中心功能和旧式服务总线功能。[转换混合命名空间]，然后继续。转换完成后，通知中心将出现在 [Azure 门户]中。
