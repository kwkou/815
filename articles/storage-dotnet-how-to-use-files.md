...
<!--
Azure 文件存储目前发布了预览版。若要请求访问预览版，请导航到["Windows Azure 预览版"页](/zh-cn/services/preview)，然后请求访问"Azure 文件"。你的请求得到批准后，系统就会通知你，然后你就可以访问文件存储预览版。然后，你就可以创建用于访问文件存储的存储帐户。
-->
