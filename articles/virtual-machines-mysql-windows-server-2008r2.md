...
[MySQL](http://www.mysql.com) is a popular open source, SQL database. Using the [Azure Management Portal](http://www.windowsazure.cn), you can create a virtual machine running Windows Server 2008 R2 from the Image Gallery. You can then install and configure a MySQL database on the virtual machine.
...
After the virtual machine is created, attach a data disk. This disk provides data storage you'll need when you install MySQL. See [How to Attach a Data Disk to a Windows Virtual Machine](/zh-cn/documentation/articles/storage-windows-attach-disk/) and follow the instructions for attaching an empty disk.
