...
- 计算节点的**操作系统**和**版本**
    ...
    “云服务配置”*只*提供 Windows 计算节点。[Azure 来宾 OS 版本和 SDK 兼容性对照表](/documentation/articles/cloud-services-guestos-update-matrix/)中列出了适用于云服务配置池的操作系统。创建包含云服务节点的池时，只需指定节点大小及其 *OS 系列*。创建 Windows 计算节点池时，最常使用的是云服务。
