<properties linkid="service-bus-event-hubs-csharp-storm-getstarted" pageTitle="事件中心入门" metaKeywords="Azure 服务总线, Event Hub, getting started Event Hubs" description="Follow this tutorial to get started using Azure Event Hubs sending events with C# and receiving them in an Apache Storm cluster" metaCanonical="" services="" documentationCenter="" title="Get Started with Event Hubs" authors="elioda" solutions="" manager="timlt" editor="" />
