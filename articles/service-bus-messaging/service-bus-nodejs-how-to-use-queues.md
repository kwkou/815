...
<tags
    ...
    ms.openlocfilehash="59cc5058f94c8bbd3eb61bc0601e6074c80e20f8"
...
有关在 Azure 云服务的配置文件中设置环境变量的示例，请参阅[使用存储的 Node.js 云服务][]。

有关在 [Azure 经典管理门户][]中为 Azure 网站设置环境变量的示例，请参阅[使用存储的Node.js Web 应用程序][]。
...
-   [Node.js 开发人员中心](/develop/nodejs/)
  ...
  [创建 Node.js 应用程序并将其部署到 Azure 网站]: /documentation/articles/app-service-web-get-started-nodejs/
  [使用存储的 Node.js 云服务]: /documentation/articles/storage-nodejs-use-table-storage-cloud-service-app/
  [使用存储的 Node.js Web 应用程序]: /documentation/articles/storage-nodejs-how-to-use-table-storage/
