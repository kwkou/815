<properties
    pageTitle="将 Azure 中的数据还原到 Windows Server 或 Windows 计算机 | Microsoft 文档"
...
# <a name="restore-files-to-a-windows-server-or-windows-client-machine-using-resource-manager-deployment-model"></a>使用资源管理器部署模型将文件还原到 Windows Server 或 Windows 客户端计算机
> [AZURE.SELECTOR]
...
- 恢复文件和文件夹后，可以[管理备份](/documentation/articles/backup-azure-manage-windows-server-classic/)。
