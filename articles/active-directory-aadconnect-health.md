...
| 要求 | 说明|
| ----------- | ---------- |
<!-- |Azure AD Premium| Azure AD Connect Health 是 Azure AD Premium 的一个功能，它需要与 Azure AD Premium 配合使用。</br></br>有关详细信息，请参阅 [Azure AD Premium 入门](active-directory-get-started-premium)。</br></br>若要开始 30 天免费试用，请参阅[开始试用](https://azure.microsoft.com/trial/get-started-active-directory/)。|。-->
