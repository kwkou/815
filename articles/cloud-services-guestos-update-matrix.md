...
###### **2015 年 12 月 18 日**
201511-02 11 月版来宾 OS 发行日期已从 2015 年 12 月 16 日推迟到 2016 年 1 月 4 日。

###### **2015 年 12 月 9 日**
12 月版来宾 OS 将从 2015 年 12 月 10 日开始推出，预计于 2016 年 1 月 8 日正式发行。

###### **2015 年 11 月 12 日**  
2014 年 8 月 7 日，Microsoft 宣布将在 2016 年 1 月 12 日结束对 .NET Framework 4、4.5 和 4.5.1 的支持。建议客户和开发人员在 2016 年 1 月 12 日之前完成到 .NET Framework 4.5.2 的就地更新，以便继续接受技术支持和安全更新。更多详细信息，请参阅 Microsoft .NET Framework 支持生命周期策略。

我们已经在 10 月 27 日宣布，Azure 会将 Azure 来宾操作系统（来宾 OS）2.x、3.x 和 4.x 系列中的 .NET Framework 更新到 .NET Framework 4.5.2，后者会在即将发布的 11 月来宾 OS 版本中推出。自那以后，我们根据收到的客户反馈推迟了自动更新（即更新到包含 .NET 4.5.2 的 OS 版本），并提供了包含 .NET 4.5.2 的映像进行测试验证。

为了更好地满足客户的要求并确保顺利升级到 .NET 4.5.2，Azure 会在 2016 年 1 月的来宾 OS 版本中，将 Azure 来宾操作系统（来宾 OS）2.x、3.x 和 4.x 系列中的 .NET Framework 更新到 .NET Framework 4.5.2。在启用了自动更新的来宾 OS 2.x、3.x 和 4.x 系列上运行的云服务将会更新到包含 .NET Framework 4.5.2 的 2016 年 1 月版来宾 OS。在默认 OS 中安装的 .NET Framework 不会在 11 月份进行更改。为了帮助客户验证其云服务是否兼容 .NET 4.5.2，Azure 会提供另外一组包含 .NET 4.5.2 的 11 月 OS 版本 201511-02，以方便客户进行手动部署。

下表捕获了将要应用的更改。
 
| 来宾 OS 系列 | 在来宾 OS 201511-02 版本之前安装了 .NET Framework | 在来宾 OS 201511-02 版本之上安装了 .NET Framework | 在来宾 OS 201512-01 版本之上安装了 .NET Framework | 在来宾 OS 201601-01 或更高版本之上安装了 .NET Framework |
| --------------- | ---------------- | ---------------- | ---------------- | ---------------- |
| 基于 Windows Server 2008 R2 的 OS 2.x 系列 | .NET 3.5、.NET 4.0 | .NET 3.5、.NET 4.5.2 | .NET 3.5、.NET 4.0 | .NET 3.5、.NET 4.5.2 |
| 基于 Windows Server 2012 的 OS 3.x 系列 | .NET 4.5 | .NET 4.5.2 | .NET 4.5 | .NET 4.5.2 | 
| 基于 Windows Server 2012 R2 的 OS 4.x 系列 | .NET 4.5.1 | .NET 4.5.2 | .NET 4.5.1 | .NET 4.5.2 | 
 
如果你要进行来宾 OS 手动更新，请注意，在 11 月份将有两个针对所有来宾 OS 系列的来宾 OS 版本发布。

   • WA-GUEST-OS-4.26\_201511-01、WA-GUEST-OS-3.33\_201511-01、WA-GUEST-OS-2.45\_201511-01（默认）

   这其中包括 11 月版 MSRC 和 10 月版 Windows 汇总

   • WA-GUEST-OS-4.26\_201511-02、WA-GUEST-OS-3.33\_201511-02、WA-GUEST-OS-2.45\_201511-02

   这其中包括 11 月版 MSRC、10 月版 Windows 汇总和 .NET Framework（已升级到 .NET 4.5.2）



在升级之前，可通过下面的某些选项来帮助验证你的云服务是否兼容 .NET 4.5.2：

1. 	将测试型云服务角色部署到 201511-02 版，然后执行应用程序兼容性验证。 

2. 	在测试型云服务角色上安装 .NET 4.5.2，然后执行应用程序兼容性验证。请参阅[在云服务角色上安装 .NET] 以获取相关说明。

3. 	在独立的 VM 上执行应用程序兼容性验证，可以在本地执行，也可以在安装了 .NET 4.5.2 的 Azure VM 上执行。




###### **2015 年 10 月 15 日**
10 月版来宾 OS 将从今天（2015 年 10 月 15 日）开始推出，预计于 2015 年 11 月 13 日正式发行。

2015 年 10 月 1 日已发行来宾 OS 4.24、3.31、2.43 版。
...
本部分列出当前支持的来宾 OS 版本。来宾 OS 系列和版本具有发布日期、停用日期和到期日期。截至发布日期，可以在 Azure 经典门户中手动选择来宾 OS 版本。来宾 OS 将在“停用”日期当日或之后从 Azure 经典门户中删除。然后它处于“过渡中”状态，但受到有限的更新部署功能的支持。到期日期是计划彻底从 Azure 系统中删除某个版本或系列的日期。仍在过期的版本上运行的云服务将被停止、删除或强制升级到较新的版本，如 [Azure 来宾 OS 可支持性和停用策略][retirepolicy]中所述。
...
**来宾 OS 发行版**是指来宾 OS 版本的再发行版。如果 Microsoft 在测试期间发现需要更改的问题，就会出现再发行版。最新的发行版始终会取代任何以前的发行版（无论是否公开）。Azure 经典门户将只允许用户选取给定版本的最新发行版。通常，不会对运行在以前版本上的部署进行强制升级，具体取决于 Bug 的严重性。
...
| ---------------- | -------------------------- | ---------------------- | ------------ | --- |
| 4\.27 | WA-GUEST-OS-4.27\_201512-01 | 预计于 2016 年 1 月 8 日发行 | 将在 4.29 发行时更新 | TBD |
| 4\.26 | WA-GUEST-OS-4.26\_201511-02 | 预计于 2016 年 1 月 4 日发行 | 将在 4.28 发行时更新 | TBD |
| 4\.26 | WA-GUEST-OS-4.26\_201511-01 | 2015 年 12 月 10 日 | 将在 4.28 发行时更新 | TBD |
| 4\.25 | WA-GUEST-OS-4.25\_201510-01 | 2015 年 11 月 6 日 | 将在 4.27 发行时更新 | TBD |
...
| 来宾 OS 版本 | 配置字符串 | 发布日期 | 停用日期 | 到期日期 |
| ---------------- | -------------------------- | ---------------------- | ------------ | --- |
| 3\.34 | WA-GUEST-OS-3.34\_201512-01 | 预计于 2016 年 1 月 8 日发行 | 将在 3.36 发行时更新 | TBD |
| 3\.33 | WA-GUEST-OS-3.33\_201511-02 | 预计于 2016 年 1 月 4 日发行 | 将在 3.35 发行时更新 | TBD |
| 3\.33 | WA-GUEST-OS-3.33\_201511-01 | 2015 年 12 月 10 日 | 将在 3.35 发行时更新 | TBD |
| 3\.32 | WA-GUEST-OS-3.32\_201510-01 | 2015 年 11 月 6 日 | 将在 3.34 发行时更新 | TBD |
...
| 来宾 OS 版本 | 配置字符串 | 发布日期 | 停用日期 | 到期日期 |
| ---------------- | -------------------------- | ---------------------- | ------------ | --- |
| 2\.46 | WA-GUEST-OS-2.46\_201512-01 | 预计于 2015 年 1 月 8 日发行 | 将在 2.48 发行时更新 | TBD |
| 2\.45 | WA-GUEST-OS-2.45\_201511-02 | 预计于 2016 年 1 月 4 日发行 | 将在 2.47 发行时更新 | TBD |
| 2\.45 | WA-GUEST-OS-2.45\_201511-01 | 2015 年 12 月 10 日 | 将在 2.47 发行时更新 | TBD |
| 2\.44 | WA-GUEST-OS-2.44\_201510-01 | 2015 年 11 月 6 日 | 将在 2.46 发行时更新 | TBD |
...
Windows Azure 不断地发布更新。来宾 OS 只不过是此类更新的其中一种。一个发行版本会受到许多因素影响，不胜列举。此外，Azure 实际上在成千上万的计算机上运行。这意味着无法提供重新启动你角色的准确日期和时间。我们将使用最新信息更新[来宾 OS 更新 RSS 源][rss]，但会考虑到其时间和近似时间范围。我们意识到这对于客户构成问题，并正在致力于限制重新启动或为重新启动定时的计划。
...
2. 8 月版和 9 月版来宾 OS 已在 Azure 经典门户中停用。你不能手动选择这些版本。这是为了防止你在选择此来宾 OS 版本时出现问题。
...
[在云服务角色上安装 .NET]: /documentation/articles/cloud-services-dotnet-install-dotnet/?WT.mc_id=azurebg_email_Trans_963_RevisedNET_Update
