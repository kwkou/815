<properties 
	...
	description="本主题说明如何使用 Azure 经典门户管理流式处理终结点。" 
...
本主题概述了流式处理终结点提供的主要功能。本主题还展示如何使用 Azure 经典门户管理流式处理终结点。


##添加和删除流式处理终结点

可以使用 .NET SDK、REST API 或 Azure 经典门户添加或删除流式处理终结点。

若要使用 Azure 经典门户添加/删除流式处理终结点，请执行以下操作：
...
可以使用 .NET SDK、REST API 或 Azure 经典门户进行缩放。
...
可以使用 .NET SDK、REST API 或 Azure 经典门户配置这些属性。
