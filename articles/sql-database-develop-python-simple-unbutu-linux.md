...
[Pymssql.connect](http://pymssql.org/zh/latest/ref/pymssql.html) 函数用于连接到 SQL Database。
...
[Cursor.execute](http://pymssql.org/zh/latest/ref/pymssql.html#pymssql.Cursor.execute) 函数可用于针对 SQL Database 从查询中检索结果集。此函数实际上可接受任何查询，并返回可使用 [cursor.fetchone()](http://pymssql.org/zh/latest/ref/pymssql.html#pymssql.Cursor.fetchone) 循环访问的结果集。
