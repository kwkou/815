...
- 非生产槽不支持链接的资源管理。在 [Azure 经典门户](https://manage.windowsazure.cn/)中，你可以通过暂时将非生产槽移到其他 App Service 计划模式来避免对生产槽造成这种潜在影响。请注意，非生产槽必须先再次与生产槽共享相同的模式，才能交换这两个槽。
...
4. 当你单击部署槽名称时，将打开一个包含一组选项卡的页面，这与其他 Web 应用一样。<strong>你的 Web 应用名称（部署槽名称）</strong>将显示在经典门户页面顶部，提醒你正在查看部署槽。
