...
“常规故障排除步骤”部分列出了解决常见问题的步骤。“详细故障排除步骤”部分按特定的错误消息提供了解决步骤。开始之前，以下是了解分配工作原理及分配故障发生原因的一些背景信息。你也可以[在 Azure 中创建、重新启动 Windows VM 或调整其大小时排查分配失败](/documentation/articles/virtual-machines-windows-allocation-failure)。
