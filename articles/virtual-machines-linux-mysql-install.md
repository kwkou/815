...
- 步骤 1：为 `root` 用户安装 MySQL Server 5.6 开关：
    ...
    ![图像](./media/virtual-machines-linux-mysql-install/virtual-machines-linux-mysql-install-p01.png)


    再次输入密码进行确认。

    ![图像](./media/virtual-machines-linux-mysql-install/virtual-machines-linux-mysql-install-p02.png)
