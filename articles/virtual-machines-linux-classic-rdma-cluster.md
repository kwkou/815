...
* **HPC Pack** - 在 Azure 中创建 Microsoft HPC Pack 群集，然后添加运行受支持 Linux 分发版的计算节点。可以将某些 Linux 节点配置为访问 RDMA 网络。请参阅 [Azure 的 HPC Pack 群集中的 Linux 计算节点入门](/documentation/articles/virtual-machines-linux-classic-hpcpack-cluster)。
...
然后，从客户端计算机运行以下 Azure CLI 命令，以捕获映像。有关详细信息，请参阅[如何捕获经典 Linux 虚拟机以用作映像](/documentation/articles/virtual-machines-linux-classic-capture-image)。
