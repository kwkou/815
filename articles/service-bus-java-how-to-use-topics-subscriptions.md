<properties
	pageTitle="如何通过 Java 使用服务总线主题 | Windows Azure"
...
在生成本示例之前，请确保已安装 [Azure SDK for Java][]。如果使用了 Eclipse，则可以安装包含 Azure SDK for Java 的 [Azure Toolkit for Eclipse][]。然后，你可以将 **Windows Azure Libraries for Java** 添加到你的项目：
