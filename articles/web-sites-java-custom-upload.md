...
请注意，Azure 提供了一种使用 Azure 经典门户配置 UI 创建 Java Web 应用的方法，如 [Azure Web 应用和 Java 入门](/documentation/articles/web-sites-java-get-started)中所述。此教程适用于无需使用 Azure 配置 UI 的方案。
