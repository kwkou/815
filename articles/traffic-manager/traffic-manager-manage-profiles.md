...
可以使用 Azure 门户预览创建流量管理器配置文件。 在创建配置文件后，可以在 Azure 门户预览中配置终结点、监视以及其他设置。 流量管理器支持每个配置文件最多 200 个终结点。 但是，大多数使用方案只需要少量的终结点。
...
3. 在浏览器中，登录 [Azure 门户预览](http://portal.azure.cn)。
