...
Azure Multi-Factor Authentication 可帮助保护对数据和应用程序的访问，同时可以满足用户对简单登录过程的需求。它通过各种简单的验证选项（例如电话、短信、移动应用通知或验证码）来提供强大的身份验证。
...
- **可缩放** - Azure Multi-Factor Authenticaton 利用云技术认证,这种保护甚至可以延伸到高事务量的任务关键型方案。
