...
使用[将 SQL 数据库 Web/企业数据库升级到新服务层](/documentation/articles/sql-database-upgrade-new-service-tiers)和 [Azure SQL 数据库服务层和性能级别](https://msdn.microsoft.com/zh-c/library/azure/dn741336.aspx)中的信息为 Azure SQL 数据库确定适当的服务层和性能级别。
