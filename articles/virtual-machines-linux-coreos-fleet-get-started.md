...
这有两个在 Azure [CoreOS] 虚拟机的群集上使用 [fleet](https://github.com/coreos/fleet) 和 [Docker](https://www.docker.com/) 运行应用程序的快速示例。
...
[配置负载平衡集]: /documentation/articles/load-balancer-get-started-internet-classic-cli
