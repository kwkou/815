...
4. 切换到工作目录 (`CD`) 并克隆示例 Node.js 应用，如下所示：
...
## 后续步骤
[创建、配置 Node.js Express Web 应用，并将其部署到 Azure](/documentation/articles/app-service-web-nodejs-get-started-cli-nodejs/)。通过学习本教程，可以了解在 Azure 中运行 Node.js Web 应用所需的基本技能，如：
