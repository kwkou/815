...
将 Web 应用部署到[应用服务](/documentation/articles/app-service-changes-existing-services/)时，如果应用在“标准”或“高级”应用服务计划模式下运行，则可以部署到单独的部署槽而不是默认的生产槽。部署槽实际上是具有自身主机名的实时 Web 应用。两个部署槽（包括生产槽）之间的 Web 应用内容与配置元素可以交换。将应用程序部署到部署槽具有以下优点：
...
2. 单击“设置”，然后单击“部署槽”。然后，在“部署槽”边栏选项卡中单击“添加槽”。
	...
	> [AZURE.NOTE]
	如果 Web 应用尚未处于“标准”或“高级”模式，则会收到消息，其中指出启用过渡支持的模式。此时，可以选择“升级”，并导航到 Web 应用的“缩放”选项卡，然后再继续。
...
5. 在“部署槽”边栏选项卡中，单击部署槽以打开该槽的边栏选项卡，其中包含一组指标和配置，这与任何其他 Web 应用一样。“你的Web 应用名称(部署槽名称)”将显示在边栏选项卡的顶部，提醒你正在查看该部署槽。
...
1. 在“部署槽”边栏选项卡中，选择一个非生产槽，单击该槽边栏选项卡的“所有设置”。
