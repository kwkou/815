<properties pageTitle="使用配置表创建跨界虚拟网络" description="本主题介绍如何使用预先确定的配置表配置跨界虚拟网络。" documentationCenter="" services="virtual-machines" authors="JoeDavies-MSFT" manager="timlt" editor=""/>
