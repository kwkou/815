...
Azure Linux 代理 (waagent) 管理虚拟机和 Azure 结构控制器之间的交互。它执行以下操作：
...
- [认可 Linux on Azure 的其他分发提供商](http://support.microsoft.com/kb/2805216)
...
下面详细描述了各种配置选项。 
配置选项分为三种类型：布尔、字符串或整数。 
布尔配置选项可指定为"y"或"n"。 
特殊关键字"无"可用于某些字符串类型配置条目，详细信息如下所示。
