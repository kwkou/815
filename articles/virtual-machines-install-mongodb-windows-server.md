...
For instructions on initalizing the disk, see "How to: Initialize a new data disk in Windows Server" in [How to Attach a Data Disk to a Windows Virtual Machine](/zh-cn/documentation/articles/storage-windows-attach-disk/).
