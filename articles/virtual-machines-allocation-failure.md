<properties
	pageTitle="排查 VM 分配失败 | Azure"
	description="在 Azure 中创建、重新启动 VM 或调整其大小时排查分配失败"
...
# 在 Azure 中创建、重新启动 VM 或调整其大小时排查分配失败
...
“常规故障排除步骤”部分列出了解决常见问题的步骤。“详细故障排除步骤”部分按特定的错误消息提供了解决步骤。开始之前，以下是了解分配工作原理及分配故障发生原因的一些背景信息。
...
![固定分配故障](./media/virtual-machines-allocation-failure/Allocation2.png)
...
- 将 VM 重设为不同的 VM 大小。<br>
	单击“虚拟机”> 你的虚拟机 >“配置”>“大小”。有关详细步骤，请参阅[调整虚拟机的大小](https://msdn.microsoft.com/zh-cn/library/dn168976.aspx)。
...
- 如果现有云服务使用区域虚拟网络，你只需将新云服务添加到同一虚拟网络。
- 如果现有云服务未使用区域虚拟网络，请为新云服务创建新的虚拟网络，然后[将现有虚拟网络连接到新虚拟网络](https://azure.microsoft.com/blog/vnet-to-vnet-connecting-virtual-networks-in-azure-across-different-regions/)。请参阅有关[区域虚拟网络](https://azure.microsoft.com/blog/2014/05/14/regional-virtual-networks/)的详细信息。
...
### 在 Azure Resource Manager 部署模型中排查特定的分配失败案例
以下是造成分配请求被固定的常见分配案例。我们将在本文稍后深入探讨每一个案例。
