...
- 将 VM 重设为不同的 VM 大小。<br>
	单击“虚拟机”> 你的虚拟机 >“配置”>“**虚拟机大小**”。有关详细步骤，请参阅[重设虚拟机大小](https://msdn.microsoft.com/zh-cn/library/dn168976.aspx)。

- 从云服务删除所有 VM，然后重新创建 VM。<br>
	单击“虚拟机”> 你的虚拟机 >“删除”。然后，单击“新建”>“计算”> [虚拟机映像]
...
> [AZURE.NOTE]每个分配案例中列出的错误均已缩略。有关详细的错误字符串，请参阅[附录](#appendix)。
...
请转到 [Azure 支持](/support/options/)站点并单击“获取支持”。有关使用 Azure 支持的信息，请阅读 [Azure 支持 FAQ](/support/faq/)。
