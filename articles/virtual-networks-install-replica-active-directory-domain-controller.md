...
1. 在 Azure 管理门户中，单击“添加”>“网络服务”>“虚拟网络”>“自定义创建”，然后使用以下值来完成向导。
...
1. 在 Azure 管理门户中，单击虚拟网络的名称，然后单击“设置”选项卡以[重新设置虚拟网络的 DNS 服务器 IP 地址](/documentation/articles/virtual-networks-manage-dns-in-vnet)，从而使用分配到副本域控制器的静态 IP 地址，而不是本地 DNS 服务器的 IP 地址。
