...
使用 [CreatePool][net_pool_create] 创建池时，需指定一些参数，例如计算节点数目、[节点大小](/documentation/articles/cloud-services-sizes-specs)以及节点的[操作系统](/documentation/articles/cloud-services/cloud-services-guestos-update-matrix)。
