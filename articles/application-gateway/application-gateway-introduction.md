...
可以使用 REST API、PowerShell cmdlet、Azure CLI 或 [Azure 门户](https://portal.azure.cn/)来创建和管理应用程序网关。 有关应用程序网关的其他问题，请查看[应用程序网关常见问题](/documentation/articles/application-gateway-faq/)中所列的常见问题列表。
