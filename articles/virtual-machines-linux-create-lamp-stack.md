...
###步骤 2：在 Azure 经典门户中创建映像。
在 [Azure 经典门户](https://manage.windowsazure.cn/)中，单击任务栏中的**“新建”**，按照这些说明创建映像，并根据你的需要选择 Linux 映像。此示例使用 Ubuntu 14.04 映像。
...
在 Azure 经典门户中，单击“虚拟机”，然后单击你创建的虚拟机。
...
首先，从 Azure 经典门户获取你的虚拟机的 DNS 名称。依次单击**“虚拟机”->**、你的虚拟机的名称**->“仪表板”**。
