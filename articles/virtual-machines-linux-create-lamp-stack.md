<properties urlDisplayName="How to create a LAMP Stack with Windows Azure" pageTitle="如何使用 Windows Azure 创建 LAMP 堆栈" metaKeywords="Azure LAMP stack vm, LAMP stack vm, Azure LAMP stack" description="了解如何在 Windows Azure 中使用运行 Linux 的 Azure 虚拟机 (VM) 创建 LAMP 堆栈。" metaCanonical="" services="virtual-machines" documentationCenter="" title="" authors="ningk" solutions="" manager="timlt" editor="tysonn"/>

<tags
	ms.service="virtual-machines"
	ms.date="02/10/2015"
	wacn.date="06/19/2015"/>
...
如果你已有虚拟机，并且只想查找在不同 linux 分发上安装 LAMP 堆栈的基础知识，则除了本主题外，还可以参阅[在 Azure 中的 Linux 虚拟机上安装 LAMP 堆栈](virtual-machines-linux-install-lamp-stack)。
