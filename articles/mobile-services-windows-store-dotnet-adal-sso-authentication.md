...
>[AZURE.NOTE] 本教程旨在帮助您更好地了解如何通过移动服务，使用[客户端主导的登录操作](https://msdn.microsoft.com/zh-CN/library/azure/jj710106.aspx)对 Windows 应用商店应用程序进行单一登录 Azure Active Directory 身份验证。如果这是你第一次体验移动服务，请先完成[移动服务入门]教程。
