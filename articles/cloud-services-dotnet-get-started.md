...
1. 在你的浏览器中，打开 [Azure 经典门户](http://manage.windowsazure.cn)。
...
1. 在 [Azure 经典门户](http://manage.windowsazure.cn)中，单击“新建”>“数据服务”>“SQL 数据库”>“快速创建”。
...
1. Azure 完成创建数据库后，在经典门户的左窗格中单击“SQL 数据库”选项卡，然后单击新数据库的名称。
...
1. 在 [Azure 经典门户](http://manage.windowsazure.cn)中，单击“新建”>“数据服务”>“存储”>“快速创建”。
...
2. 在 [Azure 经典门户](http://manage.windowsazure.cn)中，依次单击左窗格中的“SQL 数据库”、你在本教程中创建的数据库、“仪表板”选项卡、“显示连接字符串”。
	...
	经典门户将显示连接字符串，其占位符用于输入密码。

	![连接字符串](./media/cloud-services-dotnet-get-started/connstrings.png)

4. 在 Web.Release.config 转换文件中，删除 `{connectionstring}` 并从 Azure 经典门户的 ADO.NET 连接字符串粘贴在其原位置。
