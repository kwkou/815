...
如果你还没有 Azure 帐户，可以在[试用 Azure](http://www.windowsazure.cn/pricing/1rmb-trial/) 中注册一个免费试用版。如果你有 MSDN 订阅，请参阅 [MSDN 订户的 Azure 权益](http://azure.microsoft.com/pricing/member-offers/msdn-benefits-details/)。
