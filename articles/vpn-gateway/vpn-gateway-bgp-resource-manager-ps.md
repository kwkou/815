<properties
    pageTitle="在 Azure VPN 网关上配置 BGP：Resource Manager：PowerShell | Azure"
...
有关 BGP 优点的更多讨论，以及若要了解使用 BGP 的技术要求和注意事项，请参阅 [Azure VPN 网关的 BGP 概述](/documentation/articles/vpn-gateway-bgp-overview/)。
...
在此示例中，虚拟网络属于同一订阅。 可以在不同订阅之间设置 VNet 到 VNet 连接，若要了解更多详细信息，请参阅[配置 VNet 到 VNet 连接](/documentation/articles/vpn-gateway-vnet-vnet-rm-ps/)。 请确保在创建连接时添加“-EnableBgp $True”，以启用 BGP。
