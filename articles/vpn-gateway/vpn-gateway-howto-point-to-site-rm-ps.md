...
点到站点连接不需要 VPN 设备或面向公众的 IP 地址即可运行。有关点到站点连接的详细信息，请参阅 [VPN 网关常见问题](/documentation/articles/vpn-gateway-vpn-faq/#point-to-site-connections)和[关于跨界连接](/documentation/articles/vpn-gateway-plan-design/)。
