...
<tags
    ...
    ms.openlocfilehash="c47911015655b25b17c6e06b418d316f81cd3cee"
...
1. 连接到 VNet 后，即可通过 P2S 连接连接到 VM。 若要连接到 VM，需要虚拟机的专用 IP 地址。 以下示例演示了如何通过 [Get-AzureRmNetworkInterface](https://docs.microsoft.com/zh-cn/powershell/module/azurerm.network/get-azurermnetworkinterface?view=azurermps-3.7.0) 获取专用 IP 地址。 结果返回一个列表，其中包含所有资源组中的 VM 和相应的专用 IP 地址。 
...
<!--Update_Description: add "connect to VM"-->