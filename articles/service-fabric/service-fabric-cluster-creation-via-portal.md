...
>[AZURE.NOTE] 仅支持运行受支持 Service Fabric 版本的群集。如果选择“手动”模式，则需要自行负责将群集升级到支持的版本。有关结构升级模式的详细信息，请参阅 [service-fabric-cluster-upgrade 文档][service-fabric-cluster-upgrade]。
