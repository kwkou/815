...
> [AZURE.NOTE]
此独立的 Windows Server 包已经可供购买，并且可用于生产部署。此包可能包含“预览版”中的全新 Service Fabric 功能。向下滚动到“此包中包含的预览版功能”部分，获取预览版功能的列表。可以立即[下载一份 EULA](http://go.microsoft.com/fwlink/?LinkID=733084)。
> 
> 
...
<!--update: wording update; add two links-->