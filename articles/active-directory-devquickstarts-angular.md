<properties
	pageTitle="Azure AD AngularJS 入门 | Windows Azure"
...
- 你可能还想要在应用程序的 UI 中显示用户信息。adal 服务已添加到 `userDataCtrl` 控制器，因此你可以在关联的视图 `App/Scripts/UserData.html` 中访问 `userInfo` 对象：
