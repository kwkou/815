...
若要了解如何配置重试策略，[请参阅本主题中有关 retryPolicy 的部分](https://msdn.microsoft.com/zh-CN/library/azure/dn528941.aspx)。
...
若要了解如何配置备用终结点，[请参阅本主题中有关 errorAction 的部分](https://msdn.microsoft.com/zh-CN/library/azure/dn528941.aspx)。
