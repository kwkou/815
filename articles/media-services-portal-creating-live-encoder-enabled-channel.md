<properties 
	pageTitle="如何使用 Azure 媒体服务执行实时流式处理以通过 Azure 经典门户创建多比特率流" 
	description="本教程将指导你使用 Azure 经典门户完成创建通道的步骤，该通道接收单比特率实时流，并将其编码为多比特率流。" 
...
#如何使用 Azure 媒体服务执行实时流式处理以通过 Azure 经典门户创建多比特率流
