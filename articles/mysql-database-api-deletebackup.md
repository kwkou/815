...
<tags ms.service="mysql" ms.date="" wacn.date="12/08/2015"/>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>DELETE   </td>
    <td>https://management.chinacloudapi.cn/subscriptions/{subscription-id}/resourceGroups/{resource-group-name}/providers/Microsoft.MySql/servers/{server-name}/backups/{backup-file-name}?api-version=2015-09-01 HTTP/1.1
	</td>
  </tr>
</table>
