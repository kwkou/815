<properties
    pageTitle="创建网络安全组 - Azure CLI 1.0 | Azure"
...
- [Azure CLI 2.0](/documentation/articles/virtual-networks-create-nsg-arm-cli/) - 下一代 CLI，适用于资源管理部署模型

[AZURE.INCLUDE [virtual-networks-create-nsg-intro-include](../../includes/virtual-networks-create-nsg-intro-include.md)]

[AZURE.INCLUDE [azure-arm-classic-important-include](../../includes/azure-arm-classic-important-include.md)]

本文介绍 Resource Manager 部署模型。你还可以[在经典部署模型中创建 NSG](/documentation/articles/virtual-networks-create-nsg-classic-cli/)。
...
3. 运行 **azure network nsg create** 命令以创建 NSG。
    ...
    * **-g（或 --resource-group）**。要在其中创建 NSG 的资源组的名称。对于我们的方案，为 *TestRG*。
...
3. 运行 **azure network nsg rule create** 命令以创建拒绝访问 Internet 的规则。
    ...
    预期输出：
        ...
        data:    Priority                        : 200
        info:    network nsg rule create command OK
4. 运行 **azure network vnet subnet set** 命令以将 NSG 链接至后端子网。
