<properties
    pageTitle="管理网络安全组 - Azure CLI 1.0 | Azure"
...
# 使用 Azure CLI 1.0 管理网络安全组

## 用于完成任务的 CLI 版本 

可使用以下 CLI 版本之一完成任务：

- [Azure CLI 1.0](#View-existing-NSGs)：用于经典部署模型和资源管理部署模型的 CLI
- [Azure CLI 2.0](/documentation/articles/virtual-network-manage-nsg-arm-cli/) - 下一代 CLI，适用于资源管理部署模型（详见本文）
