<properties
    pageTitle="为 VM 配置专用 IP 地址 - Azure 门户预览 | Azure"
    description="了解如何使用 Azure 门户预览为虚拟机配置专用 IP 地址。"
...
# <a name="configure-private-ip-addresses-for-a-virtual-machine-using-the-azure-portal-preview"></a>使用 Azure 门户预览为虚拟机配置专用 IP 地址
> [AZURE.SELECTOR]
