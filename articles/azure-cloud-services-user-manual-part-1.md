...
##<a id="reader"></a>2.读者  
本文详细介绍如何创建和管理 Azure 云服务，适合开发人员阅读。  

另外本文会涉及部分 Azure 订阅相关内容，请提前阅读 [Azure 管理手册](/documentation/articles/azure-ea-portal-user-manual)。
 
##<a id="azure-cloud-services-related-content"></a>3.Azure 云服务相关服务  

###<a id="azure-cloud-services-network-bandwidth"></a>3.1 Azure 云服务的带宽问题  

请参考[博客](http://www.cnblogs.com/threestone/p/4497625.html)  

###<a id="azure-cloud-services-what-is"></a>3.2 什么是 Azure 云服务  
...
###<a id="azure-cloud-service-virtual-machine-relationship"></a>3.3 Azure 云服务和虚拟机的关系  
...
###<a id="azure-cloud-services-difference-from-other-compute-services"></a>3.4 Azure 云服务和其他计算服务的区别  
...
###<a id="azure-cloud-service-supported-languages"></a>3.5 Azure 云服务支持的开发语言  

Azure Web 应用支持的开发语言包括：.NET, Java, PHP, Python, Node.js, Ruby。  

开发 Azure 云服务必须先安装 [Azure SDK](/downloads/)

###<a id="azure-cloud-service-concurrent"></a>3.6 Azure 云服务如何解决大并发  
...
###<a id="azure-cloud-service-single-instance-size"></a>3.7 Azure 云服务单个实例大小 

Azure 云服务单个实例，分为 A 系列和 D 系列：  

> [ 注意事项 ] Azure 云服务计算节点的 CPU 和 RAM 是固定搭配的，不可以按照用户的想法随意更改。  

####<a id="azure-cloud-service-a-series"></a>3.7.1 A 系列计算节点  
...
####<a id="azure-cloud-service-d-series"></a>3.7.2 D 系列计算节点
...
3.	Azure 云服务所在的计算资源是无状态的  
	...
	在下面的内容中，读者将看到，虽然我们可以通过 Visual Studio，将 Cloud Project 发布到 Azure 云服务，同时配置远程桌面连接，但是 Azure 云服务本地磁盘上的资源，都是非持久化保存的。

	如果需要保存持久化的文件，一定要使用 Azure 存储保存文件。

###<a id="azure-cloud-service-static-resource"></a>3.8 Azure 云服务使用静态资源  

我们收到很多开发人员的抱怨：我的 Web 项目文件包含了很多视频内容，大概 1 TB，发布到 Azure 云服务非常慢，应该怎么办？  
...
可参考[案例分享](http://www.cnblogs.com/threestone/p/4497625.html)  

###<a id="azure-cloud-service-cost-analysis"></a>3.9 Azure 云服务成本分析
...
###<a id="azure-cloud-service-stop-charging"></a>3.10 Azure 云服务停止计费  

最后强调一下，当我们通过 Azure 管理界面，关闭 Azure 云服务时，还是会继续计费。如下图：  
...
###<a id="azure-cloud-service-limits"></a>3.11 Azure 云服务限制  
