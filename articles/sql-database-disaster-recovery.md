...
> [AZURE.NOTE]恢复数据库会创建一个新的数据库。必须确保要恢复到的服务器具有足够的 DTU，可以容纳新数据库的容量。你可以通过[与支持人员联系](http://azure.microsoft.com/blog/azure-limits-quotas-increase-requests/)来请求增加此配额。
