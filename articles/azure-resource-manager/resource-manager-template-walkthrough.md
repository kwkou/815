...
若要查找应用商店映像的相关属性，请遵循[选择 Linux 虚拟机映像](/documentation/articles/virtual-machines-linux-cli-ps-findimage/)一文或[选择 Windows 虚拟机映像](/documentation/articles/virtual-machines-windows-cli-ps-findimage/)一文。
