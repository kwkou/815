...
## <a id="policy-definition-structure"></a> 策略定义结构
...
<!-- Update_Description:update meta properties; wording update; add new code to demostrate how to utilise the resource strategy -->