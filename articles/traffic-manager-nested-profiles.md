...
嵌套式流量管理器配置文件既可以使用 Azure Resource Manager (ARM) 配置，也可以使用 Azure 服务管理 (ASM) REST API、PowerShell cmdlet 和跨平台 Azure CLI 命令来配置。也可以通过 Azure 门户预览来使用这些配置文件，但经典门户除外。
