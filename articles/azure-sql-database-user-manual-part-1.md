...
#####<a id="compatibility"></a>3.2.5.1 兼容性
...
####<a id="azure-sql-database-concept-dtu"></a>3.5.1 DTU  
...
####<a id="azure-sql-database-max-capacity"></a>3.6.1 数据库最大容量  
...
所以可以把数据表进行切片，下面介绍横向切片 (Horizontal partitioning)。有关数据表切片，请参考[这篇文章](/documentation/articles/best-practices-data-partitioning)。  
...
####<a id="single-database-server-max-dtu"></a>3.6.4 单个数据库服务器限制最大 DTU  
...
####<a id="single-database-server-max-databases"></a>3.6.5 单个数据库服务器最多 5000 个 Database  
...
####<a id="azure-sql-database-backup"></a>3.6.6 数据库备份  
...
###<a id="azure-sql-database-limits"></a>3.7 Azure SQL 数据库的限制  
