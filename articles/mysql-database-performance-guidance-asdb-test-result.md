<properties linkid="" urlDisplayName="" pageTitle="MySQL - Azure 微软云" metaKeywords="Azure 云，技术文档，文档与资源，MySQL,数据库，性能，ASDB基准" description="针对服务层和不同版本的性能介绍，为您选择MySQL Database on Azure提供了详细的参考。我们按照ASDB基准，提供了不同版本的测试数据供您参考。" metaCanonical="" services="MySQL" documentationCenter="Services" title="" authors="" solutions="" manager="" editor="" />
