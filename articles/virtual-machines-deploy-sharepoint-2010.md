...
Users also can upload a sysprepped image on the Azure Management Portal. For more information, go to <a href="/zh-cn/manage/windows/common-tasks/upload-a-vhd/">Creating and Uploading a Virtual Hard Disk</a>. Figure 3 shows the basic steps for uploading an image to create a VM:
...
<li>If you do not have an Azure account, <a href="http://www.windowsazure.cn/pricing/1rmb-trial">sign up for a free trial of Azure</a>.</li>
</ul>
...
<li>For more information, go to <a href="/zh-cn/manage/windows/common-tasks/upload-a-vhd/#createstorage">Create a Storage Account in Azure</a>.</li>
</ul>
</li>
...
<li>You can use the SQL Server 2012 image instead of the Windows Server 2008 R2 SP1 image. For more information, go to <a href="/zh-cn/manage/windows/common-tasks/install-sql-server/">Provisioning a SQL Server Virtual Machine on Azure</a>.</li>
</ul>
</li>
...
<ul>
<li>Use the SharePoint 2010 Easy Setup Script to build a SharePoint developer machine. For more information, go to <a href="http://www.microsoft.com/zh-cn/download/details.aspx?id=23415">SharePoint 2010 Easy Setup Script</a>.</li>
...
<li>For more information about creating a new Active Directory forest on a VM on Azure Virtual Network, go to <a href="/zh-cn/manage/services/networking/active-directory-forest/">Install a New Active Directory Forest in Azure</a>.</li>
</ul>
</li>
</ul>
</li>
