...
我们提供了新的 [Windows Azure 门户](https://manage.windowsazure.cn)来支持你升级到 V12。
...
本文档涉及从 Windows Azure SQL 数据库版本 V11 到 V12 的升级。更准确地讲，版本号非常类似于 Transact-SQL 语句 **SELECT @@version;** 报告的以下两个值：
...
Windows Azure 有两个门户，每个门户针对 SQL 数据库 V12 提供不同的功能。
