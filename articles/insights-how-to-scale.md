...
在 [Azure 门户](https://manage.windowsazure.cn/)中，你可以手动设置服务的实例计数，或者设置参数以基于需求自动缩放。这通常称为扩大或缩小。
...
1. 在 [Azure 门户](https://manage.windowsazure.cn/)中，单击“浏览”，然后导航到你要缩放的资源（如“App Service 计划”）。
