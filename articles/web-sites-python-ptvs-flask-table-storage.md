...
2. 单击经典门户左下角的“新建”图标，然后单击“数据服务”>“存储空间”>“快速创建”。为存储帐户命名一个唯一名称。
...
在此部分中，我们将配置应用程序以使用我们刚刚创建的存储帐户。我们将了解如何从 Azure 经典门户中获取连接设置。然后我们将在本地运行应用程序。

1.  在[Azure 经典门户][]中，单击在上一部分中创建的存储帐户。
...
1.  选择已经下载好的“发布配置文件”，然后确认。
	...
	如果还没有下载“发布配置文件”，或者还没新建 Web 应用，请到 Azure 经典门户新建一个，然后再“仪表板”的“速览”下，下载“发布配置文件”
...
1.  在 [Azure 经典门户] 中，依次单击“浏览”>“Web 应用”和您的 Web 应用名称，打开 Web 应用的边栏选项卡。
