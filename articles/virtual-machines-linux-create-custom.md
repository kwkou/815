<properties
	pageTitle="创建 Linux VM | Windows Azure"
...
[AZURE.INCLUDE [了解部署模型](../includes/learn-about-deployment-models-classic-include.md)] []资源管理器模型](/documentation/articles/virtual-machines-linux-tutorial-portal-rm)。
