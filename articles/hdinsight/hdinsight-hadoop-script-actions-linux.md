...
可以通过 Azure 门户预览、Azure PowerShell、Azure Resource Manager 模板或 HDInsight .NET SDK 使用脚本操作来自定义 HDInsight 群集。有关说明，请参阅 [How to use script action](/documentation/articles/hdinsight-hadoop-customize-cluster-linux/)（如何使用脚本操作）。
