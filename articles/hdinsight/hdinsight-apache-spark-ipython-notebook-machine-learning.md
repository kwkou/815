...
1. 在 [Azure 门户预览](https://portal.azure.cn/)的启动板中，单击 Spark 群集磁贴（如果已将其固定到启动板）。也可以单击“全部浏览”>“HDInsight 群集”导航到群集。
...
* [使用 Scala 创建独立应用程序](/documentation/articles/hdinsight-apache-spark-create-standalone-application/)
