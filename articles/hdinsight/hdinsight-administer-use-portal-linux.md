...
如果收到 NoRegisteredProviderFound 或 MissingSubscriptionRegistration 错误，请参阅[排查使用 Azure Resource Manager 时的常见 Azure 部署错误](/documentation/articles/resource-manager-common-deployment-errors/)。
...
* [将 Hive 与 HDInsight 配合使用](/documentation/articles/hdinsight-hadoop-use-hive-ambari-view/)
* [将 Pig 与 HDInsight 配合使用](/documentation/articles/hdinsight-hadoop-linux-use-ssh-unix/)
...
<!--Update_Description: add "Access Control Requirements"-->