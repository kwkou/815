<properties
	pageTitle="在 Azure 网站中创建 Java 网站 | Windows Azure"
	description="本教程演示了如何将 Java 网站部署到 Azure 网站。"
...
现在，你有了一台在 Azure 网站中运行的 Java 应用程序服务器。若要将你自己的代码部署到网站，请参阅[将应用程序或网页添加到 Java 网站](/documentation/articles/web-sites-java-add-app)。
