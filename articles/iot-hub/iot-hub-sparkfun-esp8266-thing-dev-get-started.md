<properties
    pageTitle="ESP8266 到云 - 将 Sparkfun ESP8266 Thing Dev 连接到 Azure IoT 中心 | Azure"
    description="有关将 Arduino 设备 Sparkfun ESP8266 Thing Dev 连接到 Azure IoT 中心（可帮助管理 IoT 资产的 Azure 云服务）的指南。"
    services="iot-hub"
    documentationcenter=""
    author="shizn"
    manager="timtl"
