...
你还需要服务总线队列来可靠处理交互式消息。可在 1 小时的重复数据删除时间范围内，以编程方式创建队列，如[如何使用服务总线队列][Service Bus queue]中所述。还可按以下步骤使用 [Azure 经典门户][lnk-classic-portal]：
...
4. 搜索 **Microsoft Azure 服务总线事件中心 - EventProcessorHost**，单击“安装”并接受使用条款。此操作会下载和安装 [Azure 服务总线事件中心 — EventProcessorHost Nuget 包](https://www.nuget.org/packages/Microsoft.Azure.ServiceBus.EventProcessorHost)，并添加对其的引用（包括所有依赖项）。
