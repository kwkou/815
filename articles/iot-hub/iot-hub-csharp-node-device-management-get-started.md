...
若要从基于云的后端应用远程启动和监视设备上的设备管理操作，请使用 IoT 中心基元（如[设备孪生][lnk-devtwin]和[从云到设备 (C2D) 的方法][lnk-c2dmethod]）。本教程说明后端应用和设备如何协同工作，实现从 IoT 中心启动和监视远程设备重新启动。
...
**TriggerReboot**：在模拟设备上调用直接方法、显示响应以及显示更新的设备孪生报告属性。
