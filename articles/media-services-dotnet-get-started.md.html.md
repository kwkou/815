...
<h2><a id="Step2"></a>获取 Media Services 上下文</h2>
...
1.  创建一个空资产
	...
	<strong>说明</strong> 
	<p>Media Services 提供磁盘存储加密，而不通过数字版权管理器 (DRM) 等途径加密。</p> 
	</div>
...
<h2><a id="Step4"></a>在服务器上为资产编码并下载输出资产</h2>
...
<div class="dev-callout"> 
<strong>说明</strong> 
<p>在 Media Services 对象模型中，资产是代表一个或多个文件的 Media Services 内容集合对象。定位器路径提供 Azure Blob URL，该 URL 是此资产在 Azure 存储空间中的基路径。若要访问资产中的特定文件，请在定位器基路径中添加一个文件名。</p> 
</div>
