<properties 
	pageTitle="在 Windows 应用商店应用程序中使用 Azure 存储空间 | Windows Azure" 
...
- [适用于 Windows 运行时的 Windows Azure 存储客户端库](http://blogs.msdn.com/b/windowsazurestorage/archive/2012/11/05/windows-azure-storage-client-library-for-windows-runtime.aspx) 提供用于使用 Azure 存储空间的类库。
