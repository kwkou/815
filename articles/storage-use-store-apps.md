...
- [WCF Data Services Tools for Windows Store Apps](http://www.microsoft.com/zh-cn/download/details.aspx?id=30714) extends the Add Service Reference experience with client-side OData support for Windows Store Apps in Visual Studio 2012.
