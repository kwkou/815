...
8. 完成所有这些步骤后，从 [Azure 经典门户][mgmtportal]中的 Web 应用边栏选项卡重新启动你的站点。
...
4. 在 Azure 经典门户中创建新的 Web 应用并发布 WordPress 备份。

	1. 在 [Azure 经典门户][mgmtportal]中使用“新建”->“计算”->“Web Apps”->“快速创建”创建一个包含数据库的新 Web 应用。配置所有所需的设置来创建空 Web 应用。
