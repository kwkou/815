...
1. 在“帐户名称”中选择你要使用的存储帐户。
    ...
    如果手动输入存储帐户凭据，请在“帐户密钥”中复制或键入你的主密钥。可从 Azure 经典门户复制此密钥。若要复制此密钥，请在 Azure 经典门户的“存储帐户”视图中遵循以下步骤：
...
>[AZURE.IMPORTANT] 这些证书不会与服务一起打包。必须通过 Azure 平台经典门户将证书分别上载到 Azure
