...
[不受支持的表功能]: /documentation/articles/sql-data-warehouse-tables-overview.md#unsupported-table-features/
[数据类型]: /documentation/articles/sql-data-warehouse-tables-data-types.md
[不受支持的数据类型]: /documentation/articles/sql-data-warehouse-tables-data-types.md#unsupported-data-types
[数据类型最佳实践]: /documentation/articles/sql-data-warehouse-tables-data-types.md#data-type-best-practices
