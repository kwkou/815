...
>[AZURE.TIP]想要构建一个简单的网站？ 如果你的方案只涉及一个简单的网站前端，则可以考虑<a href="/documentation/articles/app-service-web/web-sites-nodejs-develop-deploy-mac">使用轻型网站</a>。 随着你的网站的不断扩大和你的需求的变化，你可以轻松升级到云服务。
