<properties 
	pageTitle="从 Web 应用程序使用 Azure 密钥保管库 | Windows Azure" 
...
本教程面向 Web 开发人员，他们已经了解有关在 Azure 上创建 Web 应用程序的基本知识。有关 Azure Web Sites 的详细信息，请参阅 [Web Sites 概述](/documentation/articles/app-service-web-overview)。
