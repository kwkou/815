<properties title="Prepare an Oracle Linux Virtual Machine for Azure" pageTitle="为 Azure 准备 Oracle Linux 虚拟机" description="逐步完成在 Azure 中配置运行 Linux 的 Oracle 虚拟机。" services="virtual-machines" authors="bbenz" documentationCenter=""/>
