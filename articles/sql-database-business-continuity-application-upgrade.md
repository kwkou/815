<properties 
   pageTitle="升级应用程序期间的 SQL 数据库 业务连续性" 
...
如果应用程序可以暂时在只读模式下运行，则可以将升级工作流设计为有效消除总体停机时间。若要了解如何针对特定的应用程序拓扑实施升级工作流，请参阅[滚动升级应用程序期间最大程度地减少 Azure SQL DB 中断的最佳实践](https://msdn.microsoft.com/zh-cn/library/azure/dn790385.aspx)
