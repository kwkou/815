...
> [AZURE.NOTE] 本文介绍如何在现有 Azure 帐户产品/服务中移动资源。 <!-- 如果你确实想要更改 Azure 帐户产品/服务（如从即用即付升级到预付）同时继续使用现有资源，请参阅 [Switching to a different Azure offer（切换到其他 Azure 产品/服务）](/documentation/articles/billing-how-to-switch-azure-offer)。 -->
...
你可以通过门户移动一些资源；不过，并非所有支持移动操作的资源提供程序都通过门户提供该功能。
...
将通过经典模型部署的资源移到新的资源组时，你可以使用资源组名称旁边的编辑图标。
