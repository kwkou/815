...
<table border="1" cellspacing="0" cellpadding="0">
    <tbody>
        ...
        <tr>
            ...
            <td width="204" valign="top">
                <p>
                    通过 Azure 经典门户获得对示例数据的交互式创作和调试体验。
                </p>
            </td>
            <td width="246" valign="top">
                <p>
...
<table border="1" cellspacing="0" cellpadding="0">
    <tbody>
        ...
        <tr>
            ...
            <td width="204" valign="top">
                <p>
                    部署是通过 Azure 经典门户、PowerShell 和 REST API 实现的。
                </p>
            </td>
            <td width="246" valign="top">
                <p>
                    部署是通过 Azure 经典门户、PowerShell、Visual Studio 和 REST API 实现的。
                </p>
            </td>
        </tr>
        <tr>
            ...
            <td width="204" valign="top">
                <p>
                    监视是通过 Azure 经典门户和 REST API 实现的。
                </p>
                <p>
                    用户还可以配置 Azure 警报。
                </p>
