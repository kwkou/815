...
有关详细信息，请参阅 [ASP.NET vNext][ASP.NET vNext]。
  ...
  [入门]: /zh-cn/documentation/articles/vs-storage-aspnet-vnext-getting-started-tables/
  ...
  [队列]: /zh-cn/documentation/articles/vs-storage-aspnet-vnext-getting-started-queues/
