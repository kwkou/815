<properties pageTitle="创建 FreeBSD VHD 并将其上载到 Azure" description="了解如何创建和上载包含 FreeBSD 操作系统的 Azure 虚拟硬盘 (VHD)。" services="virtual-machines" documentationCenter="" authors="KylieLiang" manager="timlt" editor=""/>
