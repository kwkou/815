...
**未计划的故障转移** | <p>当主站点由于意外事件（例如断电或病毒攻击）而不可访问时，以相应的方式运行该类型的故障转移</p><p>即使主站点不可用，你也可以运行非计划的故障转移。</p> | <p>是否丢失数据取决于复制频率设置</p><p>数据将根据上次同步时间保持最新 </p>| <p>启动故障转移</p><p>在“作业”选项卡上跟踪进度。可选择尝试关闭虚拟机并同步最新数据</p><p>在辅助位置启动副本计算机</p><p>Azure - 在 Azure 经典管理门户中连接到副本计算机</p><p>辅助站点 - 在同一主机和云中访问计算机</p><p>提交故障转移</p>
