...
<tags 
	ms.service="sql-database" ms.date="04/29/2015" wacn.date="08/14/2015" />
...
- 弹性池只能在 Azure SQL 数据库V12 服务器中使用。   
...
| 文章 | 说明 |
| :-- | :-- |
| [SQL 数据库弹性数据库池](sql-database-elastic-pool) | 弹性池概述 |
| [使用 Azure 门户创建和管理 SQL 数据库弹性数据库池](sql-database-elastic-pool-portal) | 如何使用 Azure 门户创建和管理弹性池 |
| [使用 PowerShell 创建和管理 SQL 数据库弹性数据库池](sql-database-elastic-pool-powershell) | 如何使用 PowerShell cmdlet 创建和管理弹性池 |
...
## 命名空间和终结点详细信息
弹性池是 Microsoft Azure SQL 数据库中类型为“ElasticPool”的 ARM 资源。
