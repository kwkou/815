...
| :-- | :-- |
| [New-AzureSqlElasticPool](https://msdn.microsoft.com/zh-cn/library/mt125987.aspx) | [创建弹性数据库池](https://msdn.microsoft.com/zh-cn/library/mt163596.aspx) |
| [Set-AzureSqlElasticPool](https://msdn.microsoft.com/zh-cn/library/mt125994.aspx) | [设置弹性数据库池的性能设置](https://msdn.microsoft.com/zh-cn/library/mt163641.aspx) |
| [Remove-AzureSqlElasticPool](https://msdn.microsoft.com/zh-cn/library/mt125830.aspx) | [删除弹性数据库池](https://msdn.microsoft.com/zh-cn/library/mt163672.aspx) |
| [Get-AzureSqlElasticPool](https://msdn.microsoft.com/zh-cn/library/mt126017.aspx) | [获取弹性数据库池及其属性值](https://msdn.microsoft.com/zh-cn/library/mt163646.aspx) |
| [Get-AzureSqlElasticPoolActivity](https://msdn.microsoft.com/zh-cn/library/mt125837.aspx) | [获取弹性数据库池的操作状态](https://msdn.microsoft.com/zh-cn/library/mt163669.aspx) |
| [Get-AzureSqlElasticPoolDatabase](https://msdn.microsoft.com/zh-cn/library/mt125960.aspx) | [获取弹性数据库池中的数据库](https://msdn.microsoft.com/zh-cn/library/mt163646.aspx) |
| [Get-AzureSqlElasticPoolDatabaseActivity](https://msdn.microsoft.com/zh-cn/library/mt125973.aspx) | [获取将数据库移入和移出池的状态](https://msdn.microsoft.com/zh-cn/library/mt163669.aspx) |
...
- 弹性池的价格取决于池的 eDTU 数和池中数据库的数量。弹性池的价格与池内弹性数据库的利用率无关。
...
| 10929 | EX\_USER | %s 最小保证为 %d，最大限制为 %d，数据库的当前使用率为 %d。但是，服务器当前太忙，无法支持针对该数据库的数目大于 %d 的请求。请参阅 [http://go.microsoft.com/fwlink/?LinkId=267637](/documentation/articles/sql-database-resource-limits) 以获得帮助。否则，请稍后再试。 | 每个数据库的 DTU 最小值；每个数据库的 DTU 最大值 | 弹性池中所有数据库的并发辅助进程（请求）总数尝试超过池限制。 | 可能情况下，请考虑增加弹性池的 DTU 数，以便提高其辅助进程限制，或者从弹性池中删除数据库。 |
