<properties pageTitle="Nodejs-应用服务 - Azure 微软云" metakeywords="" description="Nodejs-应用服务 - Azure 微软云" services="" documentationCenter="nodejs" authors="" manager="Tiffena" editor="EricChen"/>
