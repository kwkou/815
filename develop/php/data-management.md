...
<h3>如何：<a href="/documentation/articles/sql-database-php-how-to-use/" ms.pgarea="content" ms.cmpgrp="body" ms.cmptyp="link" ms.cmpnm="从 PHP 访问 Azure SQL Database" ms.title="" km.title="" ms.interactiontype="1">从 PHP 访问 Azure SQL Database</a></h3>
